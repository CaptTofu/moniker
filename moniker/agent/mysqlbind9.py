...
class Service(rpc_service.Service):
    ...
    def _sync_domains(self):
        ...
        template_path = os.path.join(os.path.abspath(
            cfg.CONF.templates_path), 'mysql-bind9-config.jinja2')
    ...
    def _sync_domain(self, domain):
        ...
        # ok, need to write to the mysql-bind tables at this point

        # no need to really do this unless create or delete
        self._sync_domains()
